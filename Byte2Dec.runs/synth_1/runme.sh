...
HD_PWD='E:/Dropbox/Learning/LearningVHDL_FPGA/Byte2Dec/Byte2Dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Byte2Dec.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Byte2Dec.tcl
