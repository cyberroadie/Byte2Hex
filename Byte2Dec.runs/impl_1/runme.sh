...
HD_PWD='E:/Dropbox/Learning/LearningVHDL_FPGA/Byte2Dec/Byte2Dec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Byte2Dec.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Byte2Dec.tcl -notrace
