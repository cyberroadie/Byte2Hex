...
set_property PACKAGE_PIN J1 [get_ports S_g]					
	set_property IOSTANDARD LVCMOS33 [get_ports S_g]
#Sch name = JA2
set_property PACKAGE_PIN L2 [get_ports S_f]					
	set_property IOSTANDARD LVCMOS33 [get_ports S_f]
#Sch name = JA3
...
set_property PACKAGE_PIN H1 [get_ports S_e]					
	set_property IOSTANDARD LVCMOS33 [get_ports S_e]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports S_d]					
	set_property IOSTANDARD LVCMOS33 [get_ports S_d]
#Sch name = JA9
...
set_property PACKAGE_PIN G3 [get_ports S_DP]					
	set_property IOSTANDARD LVCMOS33 [get_ports S_DP]
